                        ...
                        <div class="top-header-wrapper">
                            <div class="logo">
                                ...
                                <?php } else if ($logo == 'image') { ?>
                                    ...
                                    <?php } else { ?>
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/logo.svg" class="site-logo" alt="<?php echo $config['cf_title']; ?>">
                                    <?php } ?>
                                    <?php } else { ?>
                            ...
                            <div class="top-header-main">
                                ...
                                <div class="header-title-search">
                                    ...
                                    <div class="input input-button">
                                        ...
                                        <div class="button"><input type="submit"><img src="<?php echo EYOOM_THEME_URL; ?>/image/search.svg" class="search-icon"/></div>
                                    </div>
                                    </form>
                                </div>
                            </div>
