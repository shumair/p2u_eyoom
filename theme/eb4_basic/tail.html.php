		...
		<div class="container">
			<div class="footer-top">
				<div class="footer-logo">
					<img src="<?php echo EYOOM_THEME_URL; ?>/image/footer-logo.svg" class="site-logo"/>
				</div>
			...
			<div class="footer-cont-info mb-4">
				<p>
					<span>CS-Center 1522-2041 주소: 서울특별시 강남구 테헤란로 123, ABC빌딩 5층</span>
					<span class="info-divider">|</span>
					<span>영업 시간: 월요일 - 금요일: 오전 9:00 - 오후 6:00</span>
					<span class="info-divider">|</span>
					<span>저희 회사는 고객 생각하며</span>
				</p>

				<p class="footer-dark-color">
					<span>soo@p2u.kr 주소: 서울특별시 강남구 테헤란로 123, ABC빌딩 5층</span>
					<span class="info-divider">|</span>
					<span>고객의 니즈를 충족시키기 위해 항상 최선을 다하고 있습니다.</span>
				</p>
			</div>
			...
			<div class="footer-cont-info">
				...
				<span class="footer-dark-color">E-mail : <a href="mailto:<?php echo $bizinfo['bi_cs_email']; ?>"><?php echo $bizinfo['bi_cs_email']; ?></a></span>
				<span class="info-divider">|</span>
				<span class="footer-dark-color">T. <?php echo $bizinfo['bi_cs_tel1']; ?></span>
				<span class="info-divider">|</span>
				<span class="footer-dark-color">F. <?php echo $bizinfo['bi_cs_fax']; ?></span>
			</div>
